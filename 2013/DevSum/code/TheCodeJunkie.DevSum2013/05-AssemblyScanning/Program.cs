namespace TheCodeJunkie.DevSum2013.AssemblyScanning
{
    using System;
    ...
    public class Framework
    {
        ...
        {
            var greeter = 
                this.Greeters.SingleOrDefault(x => x.HandlesCulture(cultureName));

            if (greeter == null)
            {
                return string.Concat("Unable to locate greeter for ", cultureName);
            }
